                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a id="btn-delete" href="{{ route('account.destroy', $account->username) }}"
                                    onclick="event.preventDefault(); return confirm('Are you sure to delete this user?') ? document.getElementById('delete-account').submit() : false;">Delete</a>
                                <form id="delete-account" action="{{ route('account.destroy', $account->username) }}"
